...
from ..schemas import (
    NotificationSchema, NotificationListResponseSchema,
...
class NotificationsController:
        ...
        try:
            ...
            async_to_sync(channel_layer.group_send)(  # type: ignore
                general_room_name,
                {
                    ...
                    'action': 'add',
                    'notification': NotificationSchema.model_validate(notification).model_dump()
                }
            )
    ...
    @route.put('/{notification_id}', response=NotificationSchema, permissions=[IsAuthenticated])
    def update_notification(self, notification_id: int, payload: UpdateNotificationSchema):
    ...
    @route.delete('/{notification_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
