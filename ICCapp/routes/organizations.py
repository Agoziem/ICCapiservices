...
class OrganizationsController:
    ...
    @route.put('/{organization_id}', response=OrganizationSchema, permissions=[IsAuthenticated])
    def update_organization(self, organization_id: int, payload: UpdateOrganizationSchema):
    ...
    @route.delete('/{organization_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
