...
from ..schemas import (
    StaffSchema, StaffListResponseSchema, PaginatedStaffResponseSchema,
...
class StaffController:
    ...
    def list_staff(self, organization_id: int, page: Optional[int] = 1, page_size: Optional[int] = 10):
    ...
    @route.post('/{organization_id}', response=StaffSchema, permissions=[IsAuthenticated])
    ...
    @route.delete('/{staff_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
