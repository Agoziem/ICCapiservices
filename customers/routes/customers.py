...
from ..schemas import (
    CustomerSchema, CustomerListResponseSchema,
...
class CustomersController:
    ...
    @route.post('/{organization_id}', response=CustomerSchema, permissions=[IsAuthenticated])
    ...
    @route.delete('/{customer_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
