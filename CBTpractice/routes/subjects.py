...
from ..schemas import (
    SubjectSchema, SubjectListResponseSchema, SubjectSummarySchema,
    CreateSubjectSchema, UpdateSubjectSchema,
    QuestionSchema, QuestionSummarySchema, CreateQuestionSchema, UpdateQuestionSchema,
    AnswerSchema, CreateAnswerSchema, UpdateAnswerSchema,
...
class SubjectsController:
    ...
    def get_subject(self, subject_id: int):
        ...
        subject = get_object_or_404(
            Subject.objects.prefetch_related('questions__answers'),
            id=subject_id
        )
        return subject
    ...
    @route.delete('/{subject_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
...
class QuestionsController:
    ...
    @route.delete('/{question_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
    ...
    @route.post('/{question_id}/answers', response=AnswerSchema, permissions=[IsAuthenticated])
...
class AnswersController:
    ...
    @route.delete('/{answer_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
