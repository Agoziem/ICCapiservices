...
from ..schemas import (
    EmailSchema, EmailListResponseSchema, CreateEmailSchema, UpdateEmailSchema,
    EmailResponseSchema, EmailResponseListSchema, CreateEmailResponseSchema, UpdateEmailResponseSchema,
    EmailMessageSchema, EmailMessageListSchema, CreateEmailMessageSchema, UpdateEmailMessageSchema,
    PaginatedEmailResponseSchema, SuccessResponseSchema, ErrorResponseSchema
)
...
class EmailsController:
    ...
    @route.get('/subscriptions/{organization_id}', response=list[EmailListResponseSchema])
    ...
    def get_emails(self, organization_id: int, page: Optional[int] = 1, page_size: Optional[int] = 10):
    ...
    @route.delete('/{email_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
...
class EmailResponsesController:
    ...
    @route.put('/{response_id}', response=EmailResponseSchema, permissions=[IsAuthenticated])
    ...
    @route.delete('/{response_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
...
class EmailMessagesController:
    ...
    @route.put('/{message_id}', response=EmailMessageSchema, permissions=[IsAuthenticated])
    ...
    @route.delete('/{message_id}', response=SuccessResponseSchema, permissions=[IsAuthenticated])
