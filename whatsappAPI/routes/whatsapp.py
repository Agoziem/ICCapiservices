...
from ..schemas import (
    ...
    WATemplateSchemaSchema,
    WATemplateSchemaListResponseSchema,
    CreateWATemplateSchemaSchema,
    UpdateWATemplateSchemaSchema,
    StatusSchema,
...
class WhatsAppController:
    ...
    def create_message(self, payload: CreateWAMessageSchema):
        ...
        try:
            ...
            message = WAMessage.objects.create(contact=contact, **message_data)
            return message
        except Exception as e:
            return {"error": str(e)}
