...
from emails.routes.emails import EmailsController, EmailResponsesController, EmailMessagesController
...
from ICCapp.routes.departments import DepartmentsController, DepartmentServicesController
...
from products.routes.categories import CategoriesController as ProductCategoriesController, SubCategoriesController
from services.routes.services import ServicesController, ServiceUserController
from services.routes.categories import ServiceCategoriesController, ServiceSubCategoriesController
...
ninja_api = NinjaExtraAPI(
    title="ICC API",
    version="1.0.0",
    description="ICC APP API endpoints"
)
